...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="Ornon" />
  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="{{ route('index') }}" class="logo">
        ...
        <svg width="124" height="27" viewBox="0 0 567 567" fill="none" class="innerLogo" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(2.834646,0,0,2.834646,0,0)"><path d="M99.593,12.5L25.981,55L99.593,97.5L173.205,55L99.593,12.5ZM99.593,32.5L138.564,55L99.593,77.5L60.622,55L99.593,32.5Z" fill="#528a38" fill-rule="nonzero"/><path d="M173.205,65L155.885,75L155.885,120L116.913,97.5L103.923,105L103.923,185L121.244,175L121.244,130L160.215,152.5L173.205,145L173.205,65Z" fill="#1f6275" fill-rule="nonzero"/><path d="M25.981,65L25.981,85L47.631,97.5L47.631,157.5L69.282,170L69.282,110L95.263,125L95.263,105L25.981,65Z" fill="#a94837" fill-rule="nonzero"/></g></svg>
      </a>
